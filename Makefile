...
lib/libsamalloc.so: samalloc.o fit_malloc.o morecore.o
	gcc -shared -g -lpthread -o lib/libsamalloc.so samalloc.o fit_malloc.o morecore.o -lrt
lib/malloc.so: malloc.o fit_malloc.o morecore.o selfcompact.o
	gcc -shared -g -lpthread -o lib/malloc.so malloc.o fit_malloc.o morecore.o -lrt
lib/libcompmalloc.so: selfcompact.o morecore.o
	g++ -shared -g -lpthread -o lib/libcompmalloc.so selfcompact.o morecore.o -lrt
...
malloc.o: src/malloc.c src/heap.h src/config.h src/debug.h 
	gcc -c -g -fpic src/malloc.c -o malloc.o -lrt
